...
objectp3d[0, :, :2] = np.mgrid[0:CHECKERBOARD[0], 0:CHECKERBOARD[1]].T.reshape(-1, 2)*CHECKERBOARD[2]
...
for filename in images:
    ...
    ret, corners = cv2.findChessboardCorners(grayColor, (CHECKERBOARD[0],CHECKERBOARD[1]),None)
    ...
    if ret == True:
        ...
        image = cv2.drawChessboardCorners(image,(CHECKERBOARD[0],CHECKERBOARD[1]),corners2, ret)
