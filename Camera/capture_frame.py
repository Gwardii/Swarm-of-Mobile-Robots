...
while(True):
    ...
    cv2.putText(frame, f"FPS {int(fps)}", (10,40), cv2.FONT_HERSHEY_SIMPLEX, 1, (100, 250, 0), cv2.LINE_4)
    ...
    if key ==ord('s'):
        cv2.imwrite(f'./captured_frames/calibration_img_{img_count}.png',frame)
        img_count+=1
